                          ...
                          const Vector3f& dir, float& tnear, float& u, float& v)
{
	...
	float S1_E1 = 1.0/dotProduct(S1, E1);
	float t = dotProduct(S2, E2) * S1_E1;
	float b1 = dotProduct(S1, S)* S1_E1;
	float b2 = dotProduct(S2, dir)* S1_E1;
	float b3 = 1 - b1 - b2;

	if (t >= 0 && b1 >= EPLISON && b2 >= EPLISON && b3 >= EPLISON)
	{
	...
	//{
	//if (t >= 0 && b1 >= EPLISON && b2 >= EPLISON && (1 - b1 - b2) >= EPLISON)
	//{
		tnear = t;
		u = b1;
		v = b2;
